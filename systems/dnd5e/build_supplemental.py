...
Usage:
    ...
    python3 build_supplemental.py --character campaigns/my-campaign/characters/aldric.md
...
SKILLS_DIR       = str(_BASE.parent.parent)
...
DATA_FILE        = str(_BASE / "data" / "dnd5e_srd.json")
SUPPLEMENTAL_FILE = str(_BASE / "data" / "dnd5e_supplemental.json")
