...
Examples:
    python3 scripts/campaign_search.py -c my-campaign Lasswater
    python3 scripts/campaign_search.py -c my-campaign "Vael letter" --files log,archive
    python3 scripts/campaign_search.py -c my-campaign VARETH Kel
